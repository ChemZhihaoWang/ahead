...
csv_path = r"D:\Desktop\hydro_channel\val_fold1.csv"
...
def formula_hp22(row):
    ...
    c1 = -3.115610209
    c2 = 0.0008050800721
    d001 = scd(row["NC"]) * row["NC"]  # Corrected scd(NC)*NC
...
def formula_hp23(row):
    ...
    d002 = np.exp(-row["NC"]) / scd(row["NC"])  # Corrected scd(NC)
    return c0 + c1 * d001 + c2 * d002
