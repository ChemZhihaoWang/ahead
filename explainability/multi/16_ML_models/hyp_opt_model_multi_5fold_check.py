...
base_output_dir = r"E:/desktop/hydro_channel/explainability/multi"
...
for fold, (train_index, test_index) in enumerate(kf.split(X), 1):
    ...
    best_hyperparameters_file = os.path.join(fold_dir, "best_hyperparameters_multi.txt")
    ...
    for name, model in models.items():
        ...
        predictions_filename = os.path.join(fold_dir, f"{name}_predictions_multi.csv")
    ...
    metrics_filename = os.path.join(fold_dir, "model_performance_metrics_bayes_opt_multi.csv")
...
final_metrics_df.to_csv(os.path.join(base_output_dir, "model_performance_metrics_bayes_opt_multi.csv"), index=False)
